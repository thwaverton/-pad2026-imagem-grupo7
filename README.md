...
|------------|-------|--------|
| João Gabriel | Líder / Integrador | [@usuario](#) |
| *(nome do integrante 2)* | Dados (Get + Explore) | [@usuario](#) |
| *(nome do integrante 3)* | Modelagem (Model) | [@usuario](#) |
| *(nome do integrante 4)* | Avaliação & Originalidade | [@usuario](#) |
| *(nome do integrante 5 — opcional)* | Comunicação | [@usuario](#) |

> ⚠️ **A preencher:** trocar os nomes entre parênteses pelos integrantes reais e colocar os usuários do GitHub. O grupo precisa ter de **3 a 6 integrantes**.

**Colaborador adicionado ao repositório:** `federsonufg` ✅
